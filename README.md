...
```
npm install @qluri/react-native-tuya
```
...
```js
import { loginWithEmail } from '@qluri/react-native-tuya';
...
```js
import { getRegisterEmailValidateCode, registerAccountWithEmail } from '@qluri/react-native-tuya';
...
```js
import { getCurrentUser } from '@qluri/react-native-tuya';
